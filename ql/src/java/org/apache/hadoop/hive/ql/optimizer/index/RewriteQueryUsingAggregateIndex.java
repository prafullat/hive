...
public final class RewriteQueryUsingAggregateIndex {
   ...
   * <p>
   * The processor also corrects the RowSchema and group-by keys by
   * replacing the existing internal names with the new internal names.
   */
