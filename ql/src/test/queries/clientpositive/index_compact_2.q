...
<<<<<<< HEAD:ql/src/test/queries/clientpositive/index_compact_2.q
CREATE INDEX srcpart_rc_index TYPE COMPACT ON TABLE srcpart_rc(key);
...
SET hive.input.format=org.apache.hadoop.hive.ql.io.HiveInputFormat;
SELECT key, value FROM srcpart_rc WHERE key=100 AND ds = '2008-04-08' and hr = 11 ORDER BY key;
>>>>>>> apache_master/trunk:ql/src/test/queries/clientpositive/index_compact_2.q
